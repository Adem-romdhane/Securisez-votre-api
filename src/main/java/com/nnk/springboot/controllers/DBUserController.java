...
import static com.nnk.springboot.services.DBUserServiceImpl.isValid;
...
public class DBUserController {
    ...
    public String validate(@Valid DBUser DBUser, BindingResult result, Model model) {
        if (!result.hasErrors()) {
            ...
            if (!isValid(password)){
                result.rejectValue("password", "error.user", "Le mot de passe ne respecte pas les critères requis.");
                return "user/add";
            }
